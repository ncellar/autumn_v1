 ...
 *   initial value.
 *
 * Note that `pf` is a "new frame", not an "old frame" (see {@link com.norswap.autumn.parsing.ParseFrame}). As such, it can
 * be modified by the means listed in {@link com.norswap.autumn.parsing.ParseFrame}.
 */
@FunctionalInterface
