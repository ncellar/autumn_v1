 ...
 * snapshot, parse changes and inputs objects. Instead we use marker interfaces ({@link Changes},
 * {@link Snapshot}, {@link Inputs} and {@link Result}) in the method signatures. You will have to
 * cast these interfaces to the concrete type in the method that accept them as parameter.
 */
